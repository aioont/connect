          ...
          <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
            <img src="https://i.pravatar.cc/300?img=70" class="mb-6 rounded-full">
              ...
              <div class="mt-6 flex space-x-8 justify-around">
                  ...
                  <p class="text-xs text-gray-500">557 posts</p>
              </div>
          </div>
      </div>
        ...
        >      
              ...
              >
                <img src="https://i.pravatar.cc/300?img=70" class="mb-6 rounded-full">
                  ...
                  <div class="mt-6 flex space-x-8 justify-around">
                      <p class="text-xs text-gray-500">{{ user.friends_count }} friends</p>
                      <p class="text-xs text-gray-500">77677 posts</p>
                  </div>
          ...
          <h2 class="mb-6 text-xl">My Friends</h2>
          <div 
          ...
          >
              ...
              >
                  ...
                  <div class="mt-6 flex space-x-8 justify-around">
                      <p class="text-xs text-gray-500">{{ user.friends_count }} friends</p>
                      <p class="text-xs text-gray-500">6647 posts</p>
                  </div>
              </div>
          </div>
      </div>
  ...
  methods: {
      ...
      handleRequest(status, pk) {
          ...
          axios
              ...
              .then(response => {
                  console.log('Friendship request data : ', response.data)  
