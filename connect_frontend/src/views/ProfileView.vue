  ...
  <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
    <div class="main-left col-span-1">
      ...
      <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
        <div class="flex justify-center"> <!-- Add this div with flex justify-center -->
        ...
        <div class="justify-center mt-6">
          <div class="mb-2" v-if="userStore.user.id === user.id">
            <RouterLink :to="{ name: 'friends', params: { id: user.id } }" class="text-gray-500 underline">
              Friends and requests
            </RouterLink>
          </div>
          <div class="mb-2" v-if="userStore.user.id === user.id">
            <RouterLink class="text-gray-500 underline" to="/profile/edit">
              Change profile picture
            </RouterLink>
          </div>
          <div class="mb-2" v-if="userStore.user.id === user.id">
            <RouterLink class="text-gray-500 underline" to="/notifications">
              View notifications
            </RouterLink>
          </div>
          <div class="mb-2" v-if="userStore.user.id === user.id">
            <RouterLink class="text-gray-500 underline" to="/chat">
              Chat
            </RouterLink>
          </div>
        </div>
